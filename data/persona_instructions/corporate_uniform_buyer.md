# Persona generation task — persona: `corporate_uniform_buyer`
...
Buying a category they need for work — basics, suiting, neutrals. They've bought similar items before and know what works. Slightly price-sensitive but value time over price. Mid-day desktop session, will probably buy two or three sizes of the same thing to keep the one that fits.

mixture_weight (share of stream): 0.05

## Required output

Write a JSON file at `/home/user/edp/data/persona_drafts/corporate_uniform_buyer.json` with this EXACT schema:

```json
{
  "name": "corporate_uniform_buyer",
