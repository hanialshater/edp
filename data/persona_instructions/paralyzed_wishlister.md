# Persona generation task — persona: `paralyzed_wishlister`
...
Has 20+ items in their wishlist across multiple visits. Looking at the current item is the 4th time in two weeks. They oscillate between this and similar items, click between recommendations, add and remove from cart. High revisit, high cart-osc, high wishlist signals. Decision paralysis is the modal state.

mixture_weight (share of stream): 0.08

## Required output

Write a JSON file at `/home/user/edp/data/persona_drafts/paralyzed_wishlister.json` with this EXACT schema:

```json
{
  "name": "paralyzed_wishlister",
