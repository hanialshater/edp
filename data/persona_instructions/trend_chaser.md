# Persona generation task — persona: `trend_chaser`
...
Saw the item on social media or a celebrity. Came in via paid ad. High style_stretch, doesn't really know the brand. Will look at "trending" or "customers chose" content. Mobile. Low fit info consumed because they care about the look, not the technical fit.

mixture_weight (share of stream): 0.05

## Required output

Write a JSON file at `/home/user/edp/data/persona_drafts/trend_chaser.json` with this EXACT schema:
