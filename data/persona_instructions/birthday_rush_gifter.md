# Persona generation task — persona: `birthday_rush_gifter`
...
Buying a gift for someone whose size they're not 100% sure about. Time pressure — birthday is in 2-3 days. They click "expedited shipping" early, are willing to spend a bit more for confidence, care a lot about "easy returns for the recipient" and gift wrapping. Style-stretch is moderate (matching recipient's taste, not theirs). Not return-anxious about money, return-anxious about giving a bad gift.

mixture_weight (share of stream): 0.07

## Required output

Write a JSON file at `/home/user/edp/data/persona_drafts/birthday_rush_gifter.json` with this EXACT schema:

```json
{
  "name": "birthday_rush_gifter",
