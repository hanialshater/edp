# Persona generation task — persona: `size_specific_anxious`
...
Has body proportions that don't match standard sizing — e.g. long torso, athletic build, between sizes. Very high size_chart usage, very high return_view, reads sizing reviews extensively. Often sizes up out of caution. Will deeply engage with fit_reassurance and size_guide widgets if shown.

mixture_weight (share of stream): 0.05

## Required output

Write a JSON file at `/home/user/edp/data/persona_drafts/size_specific_anxious.json` with this EXACT schema:

```json
{
  "name": "size_specific_anxious",
