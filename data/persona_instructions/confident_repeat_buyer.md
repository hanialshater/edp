# Persona generation task — persona: `confident_repeat_buyer`
...
Buys from this brand 3-4 times a year. Knows their size in this brand. Goes straight to product, adds to cart quickly. Low signals across the board for anxiety dimensions, low tab switching, low revisit. Premium-ish but consistent buyer.

mixture_weight (share of stream): 0.09

## Required output

Write a JSON file at `/home/user/edp/data/persona_drafts/confident_repeat_buyer.json` with this EXACT schema:

```json
{
  "name": "confident_repeat_buyer",
